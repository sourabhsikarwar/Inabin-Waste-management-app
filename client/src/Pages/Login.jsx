    ...
    return (
        <div className="min-h-screen">
            ...
            <div className="max-w-7xl flex justify-center md:flex-row flex-col container bg-white min-h-screen">
                <div className="w-3/4 md:w-3/5 text-center md:text-left mx-auto md:mx-0 pl-0 md:pl-32">
                    ...
                    <div className="w-3/5 md:w-3/5 py-7 space-y-8 mx-auto md:mx-0">
                        <div class="relative z-0">
                            ...
                            <label for="floating_standard" class="absolute text-sm font-semibold text-gray-500 dark:text-gray-400 duration-300 transform -translate-y-7 scale-75 top-3 -z-10 origin-[0] peer-focus:left-0 peer-focus:text-blue-600 peer-focus:dark:text-blue-500 peer-placeholder-shown:scale-100 peer-focus:translate-x-0 peer-placeholder-shown:translate-y-0 peer-focus:scale-75 peer-focus:-translate-y-7">Email or contact</label>
                        </div>
                        <div class="relative z-0">
                            ...
                            <label for="floating_standard" class="absolute text-sm font-semibold text-gray-500 dark:text-gray-400 duration-300 transform -translate-y-7 scale-75 top-3 -z-10 origin-[0] peer-focus:left-0 peer-focus:text-blue-600 peer-focus:dark:text-blue-500 peer-placeholder-shown:scale-100  peer-placeholder-shown:translate-y-0 peer-focus:scale-75 peer-focus:-translate-y-7">Password</label>
                        </div>
                    ...
                    <p className="text-xs md:text-sm py-4">Not disposing yet? <a href="/register" className="hover:text-darkGreen">Register Now</a></p>
                </div>
